...
class ApproximateQAgent(PacmanQAgent):
    ...
    def final(self, state):
        ...
        if self.episodesSoFar == self.numTraining:
            ...
            print
            "Learning rate(alpha) : {0}".format(self.alpha)
            print
            "Discount rate(gamma) : {0}".format(self.gamma)
            print
            "Exploration rate(epsilon) : {0}".format(self.epsilon)
            print
            "Training episodes : {0}".format(self.numTraining)
            print
            "=======Feature Weights======="
            for i in features:
                print
                "{0} : {1}".format(i, self.weights[i])
